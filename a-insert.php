        ...
        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <textarea name="pdetail" class="form-control" rows="5" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" name="pprice" class="form-control" required step="0.01" min="0">
                    </div>
                </div>
    ...
    <div class="col-md-4">
        <select name="pt" class="form-control" required>
            ...
            while ($data2 = mysqli_fetch_array($rs2)) {
                $selected = (isset($data1['pt_id']) && $data1['pt_id'] == $data2['pt_id']) ? "selected" : "";
                echo "<option value='" . htmlspecialchars($data2['pt_id']) . "' $selected>" . htmlspecialchars($data2['pt_name']) . "</option>";
            }
            ?>
        </select>
    </div>
