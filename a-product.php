                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($data['p_picture1'])): ?>
                                    <img src="images/<?= htmlspecialchars($data['p_picture1']); ?>?<?= time(); ?>" width="100%" class="img-thumbnail">
                                <?php endif; ?>

                                <?php if (!empty($data['p_picture2'])): ?>
                                    <img src="images/<?= htmlspecialchars($data['p_picture2']); ?>?<?= time(); ?>" width="100%" class="img-thumbnail">
                                <?php endif; ?>

                                <?php if (!empty($data['p_picture3'])): ?>
                                    <img src="images/<?= htmlspecialchars($data['p_picture3']); ?>?<?= time(); ?>" width="100%" class="img-thumbnail">
                                <?php endif; ?>

                                <?php if (!empty($data['p_picture4'])): ?>
                                    <img src="images/<?= htmlspecialchars($data['p_picture4']); ?>?<?= time(); ?>" width="100%" class="img-thumbnail">
                                <?php endif; ?>
                            </td>
